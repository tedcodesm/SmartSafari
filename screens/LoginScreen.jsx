      ...
      />
        ...
        <TouchableOpacity onPress={() => navigation.navigate("signup")} className="mt-4">
          <Text className="text-blue-500 text-center">
            <Text className="font-bold text-black mr-4">Don't have an account?</Text> Sign Up
          </Text>
        </TouchableOpacity>
      </View>
      ...
      >
        <View className="flex-1 items-center justify-center bg-black/50 px-6">
          <View className="bg-[#ebf7f8] p-6 rounded-2xl w-full">
            <Text className="text-red-600 font-serif text-lg font-bold mb-2">Login Failed</Text>
            <Text className="text-base font-serif text-gray-700">{errorMessage}</Text>
            <Pressable
